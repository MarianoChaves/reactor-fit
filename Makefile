...
local_CFLAGS = -g -O3 -Wall -W -w -std=c++11
...
BIN = glf_spectrum
OBJ =  glf_spectrum.o glf_spectrum_chi.o glf_probability.o emcee.o walker.o ensemble.o  

all: $(BIN)

#glf_rate: glf_rate_chi.o glf_rate.o glf_probability.o
#	g++ glf_rate_chi.o glf_rate.o glf_probability.o -o\
	 glf_rate $(LDFLAGS)  $(local_LDFLAGS)
glf_spectrum:	glf_spectrum.o glf_spectrum_chi.o glf_probability.o Binned.o emcee.o walker.o ensemble.o
	g++ glf_spectrum.o glf_spectrum_chi.o  glf_probability.o nu_pre.o Binned.o emcee.o walker.o ensemble.o -o\
